    ...
    <div>
      <style jsx>{`
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .form-box{background:var(--card-bg);border:2px solid var(--primary-purple-border);border-radius:22px;padding:38px 44px;width:100%;max-width:520px;}
        .role-switch{display:flex;gap:12px;justify-content:center;margin-bottom:24px;}
        .role-button{flex:1;border:2px solid var(--primary-purple-border);border-radius:999px;padding:12px 16px;font-family:'Nunito',sans-serif;font-weight:800;font-size:.95rem;cursor:pointer;background:var(--card-bg);}
        .role-button.active{background:var(--primary-purple);color:#ffffff;border-color:var(--primary-purple);}
        .field{margin-bottom:18px;}
        .field label{display:block;font-weight:700;font-size:.95rem;margin-bottom:8px;}
        .input-wrap{position:relative;display:flex;align-items:center;background:var(--card-bg);border:1.8px solid var(--primary-purple-border);border-radius:999px;padding:12px 18px;gap:10px;}
        ...
        .btn-login{display:block;width:100%;background:var(--card-bg);border:2px solid var(--primary-purple-border);border-radius:999px;padding:13px;font-family:'Nunito',sans-serif;font-weight:800;font-size:1rem;cursor:pointer;text-align:center;margin-top:10px;transition:background .15s;}
        .btn-login:hover{background:var(--primary-purple-bg);}
        .alt-text{margin-top:18px;text-align:center;font-size:.95rem;color:var(--text-muted);}
