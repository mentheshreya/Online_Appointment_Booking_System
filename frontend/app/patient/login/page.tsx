    ...
    <div>
      <style jsx>{`
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .form-box{background:var(--card-bg);border:2px solid var(--primary-purple-border);border-radius:22px;padding:38px 44px;width:100%;max-width:480px;}
        ...
        a.btn-login{text-decoration:none;color:var(--text-color);}
      `}</style>
      <nav>
