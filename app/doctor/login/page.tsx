    ...
    <div>
      <style jsx>{`
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .form-box{background:#dff5e6;border:2px solid #a8e6b8;border-radius:22px;padding:38px 44px;width:100%;max-width:480px;}
        .field{margin-bottom:22px;}
        .field label{display:block;font-weight:700;font-size:.95rem;margin-bottom:8px;}
        .input-wrap{position:relative;display:flex;align-items:center;background:#fff;border:1.8px solid #c0dfc9;border-radius:999px;padding:12px 18px;gap:10px;}
